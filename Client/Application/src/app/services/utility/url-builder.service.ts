...
export class UrlBuilderService {
  ...
  getImage(image: 'room-main' | 'service-main' | 'restaurant-main' | 'menu-main' | 'home-main' | 'logo' | 'support-background' | 'chefs-background' | 'profile-main' | 'chat-main' | 'users-db' |'rooms-db' |'bookings-db' |'food-db' |'announcement-db' |'language-db' |'news-db' |'order-db' |'promo-db' |'registration-db' | 'services-db' |'stock-db' | 'register-bg' | 'login-pic-1' | 'login-pic-2') {
